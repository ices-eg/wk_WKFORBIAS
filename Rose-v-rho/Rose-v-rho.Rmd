...
In both stocks, the rho-adjusted approach and Rose approach the F and SSB points in the status plots were moved in the same direction. For one stock, GBYT, the change due to the rho-adjustment was greater than from the Rose, while for the other stock, white hake, the change due to the rho-adjustment was less than from the Rose. However, in both stocks the catch advice provided by the rho-adjustment was not as much of a decrease as the change from the Rose approach. Both the rho-adjustment and Rose approaches resulted in lower catch advice, but the Rose approach was consistently lower than the rho-adjusted advice. 
